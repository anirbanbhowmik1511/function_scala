...
$c_Lcalculator_Calculator$.prototype.calculator$Calculator$$NaNSignal__Lcalculator_Signal = (function() {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  if ($is_Lcalculator_Literal(expr)) {
    ...
    var x3 = $as_Lcalculator_Ref(expr);
    var name = x3.name$2;
    try {
      var this$1 = references.get__O__s_Option(name);
      return this.eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal((this$1.isEmpty__Z() ? $m_Lcalculator_Calculator$().calculator$Calculator$$NaNSignal__Lcalculator_Signal() : this$1.get__O())).apply__O()), references)
    } catch (e) {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().calculator$Polynomial$$solution$1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set(a$2, b$2, delta$1)
    })
  })(a, b, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$solution$1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set = (function(a$2, b$2, delta$1) {
  if (($uD(delta$1.apply__O()) === 0)) {
    ...
    var a = $uD(delta$1.apply__O());
    var jsx$4 = $uD($g.Math.sqrt(a));
    var jsx$3 = $uD(a$2.apply__O());
    var jsx$2 = $uD(b$2.apply__O());
    var a$1 = $uD(delta$1.apply__O());
    var array$1 = [(((-jsx$5) + jsx$4) / (2 * jsx$3)), (((-jsx$2) - $uD($g.Math.sqrt(a$1))) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$change$1__Lcalculator_Signal__T = (function(remainingCharsCount$1) {
  return (($uI(remainingCharsCount$1.apply__O()) < 0) ? "red" : (($uI(remainingCharsCount$1.apply__O()) <= 14) ? "orange" : "green"))
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$change$1__Lcalculator_Signal__T(remainingCharsCount$1)
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(s) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, s$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(s$1.apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, s));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
